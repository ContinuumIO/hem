  ...
  Hem = (function() {
    ...
    Hem.prototype.exec = function(command) {
      ...
      switch (command) {
        case 'build':
          ...
          break;
        case 'build_split':
          console.log('Build split application');
          break;
        case 'watch':
    ...
    Hem.prototype.cssPackage = function() {
      return css.createPackage({
        ...
        target: path.join(this.options.css_public, this.options.cssPath)
      });
    };
    ...
    Hem.prototype.hemPackage = function() {
      return Package.createPackage({
        ...
        target_dir: this.options["public"],
        target_file: this.options.jsPath,
        uglify: !argv.debug,
        split: argv.split
      });
    };
    ...
    Hem.prototype.specsPackage = function() {
      return Package.createPackage({
        ...
        target_dir: this.options.testPublic,
        target_file: this.options.specsPath,
